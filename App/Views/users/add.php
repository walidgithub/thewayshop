...
<?php
    if ($errors){
        $errortext = 'يوجد مستخدم بنفس الاسم';
        ?>
...
?>
			<form method="post" name="form-user-add" id="form-user-add" enctype="multipart/form-data" class="needs-validation" novalidate>
				...
				<div class="mb-3">
					...
					<div class="input-group">
						<input name="password" type="text" class="form-control" id="username" placeholder="" required>
				...
				<div class="mb-3">
					...
					<input name="tel" type="text" class="form-control" id="tel" placeholder="" required>
