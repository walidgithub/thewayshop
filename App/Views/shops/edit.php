						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" id="Shopname" name="shopname" placeholder="Shop name" required data-error="Please enter the shop name" value="<?= $shopdata->shopname ?>">
							...
							<div class="col-md-12">
								<div class="form-group">
									<select id="Address" name="address" class="form-control" required data-error="Please enter the shop address">
                                     <option><?= $shopdata->address ?></option>
							...
							<div class="col-md-12">
								<div class="form-group">
									<select id="Category" name="category" class="form-control" required data-error="Please enter the shop category">
                                     <option><?= $shopdata->category ?></option>
							...
							<div class="col-md-12">
								<div class="form-group">
									<textarea name="description" class="form-control" id="Description" placeholder="Description" rows="4" data-error="Please enter the shop description" required><?= $shopdata->description ?></textarea>
									<div class="help-block with-errors"></div>
								</div>
							</div>
							<div class=col-md-12>
